...
{
//	private static final Log log = LogFactory.getLog(CacheMessageListener.class);
	...
	public void onMessage(Message message, byte[] pattern) {
		...
		try
		{
			...
			log.debug(String.format("recevice a redis topic message, clear local cache, the cacheName is %s, the key is %s", cacheMessage.getCacheName(), cacheMessage.getKey()));
